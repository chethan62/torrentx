...
pub(crate) struct Pal {
    ...
    pub(crate) hdr: Color32,
    pub(crate) accent: Color32,
    pub(crate) text: Color32,
    pub(crate) sub: Color32,
    pub(crate) dim: Color32,
    pub(crate) green: Color32,
    pub(crate) red: Color32,
    pub(crate) yellow: Color32,
    pub(crate) border: Color32,
    pub(crate) row_odd: Color32,
    pub(crate) row_even: Color32,
    pub(crate) row_sel: Color32,
    pub(crate) row_hov: Color32,
    pub(crate) light: bool,
}

pub(crate) fn rgb(r: u8, g: u8, b: u8) -> Color32 { Color32::from_rgb(r, g, b) }
pub(crate) fn rgba(r: u8, g: u8, b: u8, a: u8) -> Color32 { Color32::from_rgba_unmultiplied(r, g, b, a) }
